EventModule.controller('eventController', ['eventFactory', '$http', '$scope','$location', '$rootScope', function (eventFactory, $http, $scope, $location, $rootScope) {
